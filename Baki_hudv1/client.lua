...
AddEventHandler('hud:range', function(voiceRange)
	...
	TriggerEvent('scarface_notify', '#ff0000', "SaltyChat", 'Sprachreichweite: 3M')
	voicelevel = 1
	...
	TriggerEvent('scarface_notify', '#ff0000', "SaltyChat", 'Sprachreichweite: 8M')
	voicelevel = 2
	...
	TriggerEvent('scarface_notify', '#ff0000', "SaltyChat", 'Sprachreichweite: 15M')
	voicelevel = 3
	...
	TriggerEvent('scarface_notify', '#ff0000', "SaltyChat", 'Sprachreichweite: 32M')
	voicelevel = 4
